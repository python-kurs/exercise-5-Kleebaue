...
exercise = Path('/home/mklee/git/exercise-5-Kleebaue')
...
wget.download(url, out = data_dir / 'tg_ens_mean_0.25deg_reg_v19.0e2.nc')
...
# 3. Calculate monthly anomalies from the reference period for the year 2018 
#    (use the same extent as in #2).
